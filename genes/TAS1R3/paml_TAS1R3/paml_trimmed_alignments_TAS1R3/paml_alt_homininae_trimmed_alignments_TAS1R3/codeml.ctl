      seqfile = paml_alt_homininae_trimmed_dna_aligned_combined_TAS1R3 * sequence data filename
     treefile = paml_alt_homininae_ML_tree_trimmed_dna_aligned_combined_TAS1R3.txt * tree file name

      outfile = output_paml_alt_homininae_trimmed_dna_aligned_combined_TAS1R3          * main result file name

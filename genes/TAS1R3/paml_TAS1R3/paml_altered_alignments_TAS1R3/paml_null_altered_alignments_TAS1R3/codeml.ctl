      seqfile = paml_null_altered_dna_aligned_combined_TAS1R3 * sequence data filename
     treefile = paml_null_ML_tree_output_altered_dna_aligned_combined_TAS1R3.tre * tree file name

      outfile = output_paml_null_altered_dna_aligned_combined_TAS1R3          * main result file name

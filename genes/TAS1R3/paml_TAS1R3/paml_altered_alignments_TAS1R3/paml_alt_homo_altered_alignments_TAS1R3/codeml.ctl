      seqfile = paml_alt_homo_altered_dna_aligned_combined_TAS1R3 * sequence data filename
     treefile = paml_alt_homo_ML_tree_output_altered_dna_aligned_combined_TAS1R3.txt * tree file name

      outfile = output_paml_alt_homo_altered_dna_aligned_combined_TAS1R3          * main result file name

      seqfile = paml_null_trimmed_dna_aligned_combined_TAS1R1 * sequence data filename
     treefile = paml_null_ML_tree_trimmed_dna_aligned_combined_TAS1R1.tre * tree file name

      outfile = output_paml_null_trimmed_dna_aligned_combined_TAS1R1          * main result file name

      seqfile = paml_alt_hominini_trimmed_dna_aligned_combined_TAS1R1 * sequence data filename
     treefile = paml_alt_hominini_ML_tree_trimmed_dna_aligned_combined_TAS1R1.txt * tree file name

      outfile = output_paml_alt_hominini_trimmed_dna_aligned_combined_TAS1R1          * main result file name

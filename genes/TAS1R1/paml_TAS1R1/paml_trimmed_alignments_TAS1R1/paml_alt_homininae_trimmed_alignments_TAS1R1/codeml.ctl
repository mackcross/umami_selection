      seqfile = paml_alt_homininae_trimmed_dna_aligned_combined_TAS1R1 * sequence data filename
     treefile = paml_alt_homininae_ML_tree_trimmed_dna_aligned_combined_TAS1R1.tre * tree file name

      outfile = output_paml_alt_homininae_trimmed_dna_aligned_combined_TAS1R1          * main result file name

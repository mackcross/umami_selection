...
# TAS1R3 Selected Removal Alignment Analysis 

## Degrees of Freedom 
The number of null parameters was 68, while the alternative parameters for apes, homininae, hominini, and homo were all 69. Therefore, the degrees of freedom is one. 
```{r}
freedom <- 1 
```
...
## Null Model
```{r}
null_likelihood <- -13599.223151
```

## Apes Foreground 
```{r}
ape_likelihood <- -13599.068562 
...
```{r}
homininae_likelihood <- -13596.361949
...
## Hominini Foreground
```{r}
hominini_likelihood <- -13596.324496
